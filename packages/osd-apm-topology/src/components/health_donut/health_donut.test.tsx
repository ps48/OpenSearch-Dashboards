...
describe('HealthDonut', () => {
    ...
    test('renders breached SliStatus icon when health status is "breached"', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<img src={ec2Icon} alt="ec2" className="cltIcon" />} health={breachedHealth} />);
    ...
    test('renders recovered SliStatus icon when health status is "recovered"', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<img src={ec2Icon} alt="ec2" className="cltIcon" />} health={recoveredHealth} />);
    ...
    test('does not render SliStatus icon when "sli" is not provided', () => {
        render(<HealthDonut metrics={mockMetrics} size={40} icon={<img src={ec2Icon} alt="ec2" className="cltIcon" />} />);
